 ...
 *
 * CI-optimized modes (build one target only):
 *   node setup.js --build-node      build + cache Node binary only
 *   node setup.js --build-electron  build + cache Electron binary only
 */
...
// ---------------------------------------------------------------------------
// CI-optimized build modes
// ---------------------------------------------------------------------------

if (arg === '--build-node') {
    console.log('=== Building better-sqlite3 for Node only ===')
    ...
    console.log('✓ Node binary built and cached.')
    process.exit(0)
}

if (arg === '--build-electron') {
    console.log('=== Building better-sqlite3 for Electron only ===')
    ...
    console.log('✓ Electron binary built and cached.')
    process.exit(0)
}
