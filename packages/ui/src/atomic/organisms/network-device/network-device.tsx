...
import { NetworkScanAnim } from './network-device-scan-anim'
...
export const NetworkDevice = (props: NetworkDeviceProps) => {
    const { children, mac, position, deviceType, className, animation, ...rest } = props
    const GRID_SIZE = 50
        ...
        <Popover>
            ...
            >
                ...
                >
                    ...
                    {animation ? (
                        <NetworkScanAnim type={animation} maxSize={50} className="-z-10" />
                    ) : null}
                </Button>
            </PopoverTrigger>
