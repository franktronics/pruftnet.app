...
namespace pruftnet::capture_worker {
namespace {
...
using protocol::boolean_field;
using protocol::field;
using protocol::FrameRead;
using protocol::json_string;
using protocol::number;
using protocol::read_frame;
using protocol::write_frame;
